...
class Command(BaseCommand):
    ...
    예를 들어, 지난 달 물 사용량 usage = 500이므로, 이번달 물 사용량은 10% 증가한 550입니다. 다음 달 물 사용량은 이번달 사용량 550에서 10% 감소한 495 이며, 나머지 달도 동일하게 계산합니다. 
    9달 뒤까지 계산한 물 사용량은 총 5115 이며, 현재 저수지에 저장된 물의 양은 storage = 5141입니다. 따라서 물이 부족해지지 않으므로 -1을 return합니다.
    ...
    def handle(self, *args, **options):
        ...
        usage = 2000
        change = [-10, 25, -33]
        result = self.solution(storage, usage, change)
        
        print(result)
        
    def solution(self, storage, usage, change):
        total_usage = 0
