...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        seat = 10
        passengers = [["On", "On", "On", "On", "On", "On", "On", "On", "-", "-"], 
                ["On", "On", "Off", "Off", "Off", "On", "On", "-", "-", "-"], 
                ["On", "On", "On", "Off", "On", "On", "On", "Off", "Off", "Off"], 
                ["On", "On", "Off", "-", "-", "-", "-", "-", "-", "-"]]
        result = self.solution(seat, passengers)
        
        print(result)
        
    def solution(self, seat, passengers):
        num_passenger = 0
        for station in passengers:
            num_passenger += self.func4(station)
            num_passenger -= self.func3(station)
        answer = self.func1(seat - num_passenger)
